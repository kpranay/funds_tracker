...
<div ng-app ="bank_accountsApp" id="PartyApp" class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        ...
        <form class="form-inline" ng-show="PRCtrl.selectedDiv != '/PartyDetails'" ng-submit="PRCtrl.searchData()" name="PartyReportForm">
            <div class="form-group col-lg-4 col-md-6">
             ...
             <div class="form-group col-lg-4 col-md-6">
				...
				<input type="date" id="startdate" date-format="dd-MMM-yyyy HH:mm:ss" class="form-control" name="date" ng-model="PRCtrl.search.startDate">
			</div>
             <div class="form-group col-lg-4 col-md-6">
				<label for="enddate">End Date</label>
				<input type="date" id="enddate" date-format="dd-MMM-yyyy HH:mm:ss" class="form-control" name="date" ng-model="PRCtrl.search.endDate">
			</div>
        ...
        <script>
    		...
    		.controller('PartyReport', ['$http','$location','$rootScope','DetailsDataProv', function($http,$location,$rootScope,DetailsDataProv) {
				...
				self.searchData = function(){
					return $http.post('<?php echo base_url(); ?>index.php/report/getpartydata',self.search).then(
						function(response) {
