					...
					<table class="table tableevenodd table-hover" style="font-size: 11px;">
						<thead>
							<tr>
								...
								<th title="Transaction Date">Journal Type</th>
								<th title="Transaction Date">Journal ID</th>
						...
						<tbody>
							<tr ng-repeat="bank_book in PDetails.bank_books">
								...
								<td ng-bind="bank_book.ledgerType == 1 ? ( bank_book.debit_credit == 'Debit' ? 'Payment' : 'Receipt') : 'Book Entry'"></td>
								<td ng-bind="bank_book.voucher_id"></td>
